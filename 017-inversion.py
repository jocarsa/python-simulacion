...
num_agents = 1  # Aumenta el número de agentes para ver múltiples recorridos
    ...
    for step in range(steps):
        ...
        for i in range(len(agent_states["positions"])):
            ...
            if agent_states["paths"][i]:
                ...
                # Invertir las coordenadas de los puntos para realizar el efecto de espejo
                points[:, 0] = simulation_map.shape[0] - points[:, 0]  # Invertir en Y
                points[:, 1] = simulation_map.shape[1] - points[:, 1]  # Invertir en X
