...
# Función para convertir segundos a una cadena de hora en formato 24h con segundos
...
def move_agents(agent_states, simulation_map, scale_factor, steps=10):
    ...
    for step in range(steps):
        ...
        clock_image[:] = (0, 0, 0)
        time_str = seconds_to_time_str(current_time_seconds)
        cv2.putText(clock_image, time_str, (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        ...
        current_time_seconds = (current_time_seconds + time_step_seconds) % (24 * 3600)  # Avanzar el tiempo en la simulación
...
# Ejecutar la simulación con el tiempo ajustado
