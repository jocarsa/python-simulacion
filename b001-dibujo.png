...
# Cargar los sprites
sprites = {
    "yellow": cv2.imread("amarillo.png"),
    "blue": cv2.imread("azul.png"),
    "white": cv2.imread("blanco.png"),
    "cyan": cv2.imread("cyan.png"),
    "gray": cv2.imread("gris.png"),
    "magenta": cv2.imread("magenta.png"),
    "orange": cv2.imread("naranja.png"),
    "black": cv2.imread("negro.png"),
    "red": cv2.imread("rojo.png"),
    "green": cv2.imread("verde.png"),
    "dark_green": cv2.imread("verdeoscuro.png")
}
