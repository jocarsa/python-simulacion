...
def draw_pattern(canvas, num_rounds, initial_radius, growth_factor, num_points, line_thickness, circle_outer_radius, circle_inner_radius):
    ...
    for ronda in range(num_rounds):
        oldx1, oldy1 = x1[:], y1[:]  # Copy previous points
        x1, y1 = [], []
        ...
        for i in range(numero):
            ...
            if ronda > 0 and oldx1:  # Ensure oldx1 is not empty
                best_candidate = 0
                ...
                for j in range(len(oldx1)):
                    ...
                    if distance < best_distance:
                        ...
                        best_candidate = j
                pt1 = (int(oldx1[best_candidate]), int(oldy1[best_candidate]))
                pt2 = (x, y)
                cv2.line(canvas, pt1, pt2, (255, 255, 255), int(line_thickness))
