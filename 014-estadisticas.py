...
num_agents = 40  # Aumenta el número de agentes para ver múltiples recorridos
...
def move_agents(agent_states, simulation_map, scale_factor, steps=10):
    ...
    for step in range(steps):
        ...
        for i in range(len(agent_states["positions"])):
            stat_text = f"Agente {i}: Pos ({agent_states['positions'][i][0]},{agent_states['positions'][i][1]}), Necesidad: {agent_states['needs'][i]}"
